...
train_x_csv = os.path.join(data_path, 'train_x.csv')
train_y_csv = os.path.join(data_path, 'train_y.csv')
test_x_csv = os.path.join(data_path, 'test_x.csv')
features_type_csv = os.path.join(data_path, 'features_type.csv')
#load data
